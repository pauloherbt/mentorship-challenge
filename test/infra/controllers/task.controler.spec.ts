...
describe('TaskController', () => {
  ...
  const mockTask: TaskEntity = {
    ...
    status: faker.helpers.arrayElement(
      Object.values(TaskStatus).filter((value) => typeof value === 'number'),
    ) as TaskStatus,
    createdAt: new Date(),
    updatedAt: new Date(),
    createdBy: mockUser,
  ...
  describe('getById', () => {
    ...
    it('should throw badRequestException if id is invalid', async () => {
      ...
      await expect(taskController.getById(id)).rejects.toThrow(
        BadRequestException,
      );
  ...
  describe('update', () => {
    ...
    it('should throw BadRequestException if title is empty', async () => {
      ...
      await expect(
        taskController.update(id, task, response as Response),
